...
$this->p2_PageTitle2("archive-fill","Documentos del Informe","Documentos del Informe", "Gestión de Auditorías / Gestión de Informes ","CaDocumentoInforme","");

$inf=CaInformeAuditoria::model()->findByPk($id_informe);
$this->PPaudit('CaInformeAuditoria', 'audit_id', $inf->audit_id ,'Regresar al Informe de Auditoría');

$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'ca-documento-informe-grid',
	'dataProvider'=>$model->search($id_informe),
		...
		array(
				...
				'buttons'=>				['delete'=>['label'=>'Eliminar',
									...
									'download' => [
										...
										'url' => 'Yii::app()->baseUrl . "/calidaddocs/DOCUMENTOS DE INFORMES DE AUDITORÍA/Informe de Auditoría del {$data->fecha_informe}/{$data->url}"',
										'options' => [
											'title' => 'Descargar',
