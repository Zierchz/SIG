...
function MorrisDashboard(){
	...
	Morris.Donut({
		...
		data: [
			{value: 70, label: 'Almacen', formatted: 'aprox 70%' },
			{value: 15, label: 'Prestamo', formatted: 'aprox. 15%' },
			{value: 10, label: 'Lab', formatted: 'aprox. 15%' },
		],
...
function AllTimePickers(){
	...
	$('#date_example').datepicker({format: "yyyy-mm-dd",multidate: true});
}
/*-------------------------------------------
