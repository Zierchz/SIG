...
!function (t, e) {
    ...
    function W(t, e, n) {
        var i = "string" == typeof e, o = i ? n : e, r = t.replace(N, ""), s = M[r];
    ...
    function U(t, e, n, i, o) {
        if ("string" == typeof e && t) {
            n || (n = i, i = null);
            var r = W(e, n, i), s = r[0], a = r[1], l = r[2], c = R(t), u = c[l] || (c[l] = {}),
                f = F(u, a, s ? n : null);
            if (f) f.oneOff = f.oneOff && o; else {
                var h = B(a, e.replace(x, "")), d = s ? function (t, e, n) {
                    return function i(o) {
    ...
    var V = {
        on: function (t, e, n, i) {
            ...
            if ("string" == typeof e && t) {
                var o = W(e, n, i), r = o[0], s = o[1], a = o[2], l = a !== e, c = R(t), u = "." === e.charAt(0);
                if (void 0 === s) {
            ...
            var i, o = e.replace(N, ""), r = e !== o, s = H.indexOf(o) > -1, a = !0, l = !0, c = !1, u = null;
    ...
    var tt = {
        ...
        }, nt = "carousel", it = ".bs.carousel",
        ot = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, rt = {
            ...
            return n.next = function () {
                ...
                var n = this._getItemIndex(t), i = this._getItemIndex(et.findOne(".active.carousel-item", this._element));
                ...
                var n, i, o, r = this, s = et.findOne(".active.carousel-item", this._element), a = this._getItemIndex(s),
                    ...
                    if (this._isSliding = !0, u && this.pause(), this._setActiveIndicatorElement(l), this._element.classList.contains("slide")) {
                        ...
                        V.one(s, "transitionend", (function () {
                            l.classList.remove(n, i), l.classList.add("active"), s.classList.remove("active", i, n), r._isSliding = !1, setTimeout((function () {
                                V.trigger(r._element, "slid.bs.carousel", {relatedTarget: l, direction: o, from: a, to: c})
                            }), 0)
                        })), g(s, h)
                ...
                var i = L(e, "bs.carousel"), r = o(o({}, ot), tt.getDataAttributes(e));
    ...
    var ut = "collapse", ft = {toggle: !0, parent: ""}, ht = {toggle: "boolean", parent: "(string|element)"},
        dt = function () {
            function t(t, e) {
                ...
                for (var n = et.find('[data-toggle="collapse"]'), i = 0, o = n.length; i < o; i++) {
                    var r = n[i], s = f(r), a = et.find(s).filter((function (e) {
                        return e === t
                    }));
    ...
    V.on(document, "click.bs.collapse.data-api", '[data-toggle="collapse"]', (function (t) {
        ...
        var e = tt.getDataAttributes(this), n = f(this);
    ...
    function xt(t, e) {
        var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = St(e, "top"), o = St(e, "left"),
            r = n ? -1 : 1;
    ...
    function Ft(t) {
        ...
        try {
            if (Ot(10)) {
                ...
                var n = St(t, "top"), i = St(t, "left");
                e.top += n, e.left += i, e.bottom += n, e.right += i
            } else e = t.getBoundingClientRect()
        } catch (t) {
        }
        var o = {left: e.left, top: e.top, width: e.right - e.left, height: e.bottom - e.top},
            r = "HTML" === t.nodeName ? jt(t.ownerDocument) : {}, s = r.width || t.clientWidth || o.width,
    ...
    function Wt(t, e) {
        var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = Ot(10), o = "HTML" === e.nodeName,
            r = Ft(t), s = Ft(e), a = Et(t), l = yt(e), c = parseFloat(l.borderTopWidth, 10),
    ...
    function Ut(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = t.ownerDocument.documentElement,
            i = Wt(t, n), o = Math.max(n.clientWidth, window.innerWidth || 0),
            r = Math.max(n.clientHeight, window.innerHeight || 0), s = e ? 0 : St(n), a = e ? 0 : St(n, "left"),
    ...
    function qt(t, e, n, i) {
        ...
        if ("viewport" === i) r = Ut(s, o); else {
            ...
            if ("HTML" !== a.nodeName || Qt(s)) r = l; else {
                var c = jt(t.ownerDocument), u = c.height, f = c.width;
    ...
    function Kt(t, e, n) {
        var i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null, o = i ? Vt(e) : Dt(e, Tt(n));
        return Wt(n, o, i)
    }
    ...
    function $t(t, e, n) {
        n = n.split("-")[0];
        var i = Xt(t), o = {width: i.width, height: i.height}, r = -1 !== ["right", "left"].indexOf(n),
    ...
    function pe(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = de.indexOf(t),
            i = de.slice(n + 1).concat(de.slice(0, n));
        return e ? i.reverse() : i
    }

    var me = "flip", ge = "clockwise", ve = "counterclockwise";
            ...
            shift: {
                ...
                order: 500, enabled: !0, fn: function (t, e) {
                    ...
                    var o = t.placement.split("-")[0], r = t.offsets, s = r.popper, a = r.reference,
                        ...
                        f = u.toLowerCase(), h = l ? "left" : "top", d = l ? "bottom" : "right", p = Xt(i)[c];
                    a[d] - p < s[f] && (t.offsets.popper[f] -= s[f] - (a[d] - p)), a[f] + p > s[d] && (t.offsets.popper[f] += a[f] + p - s[d]), t.offsets.popper = Rt(t.offsets.popper);
                    var m = a[f] + a[c] / 2 - p / 2, g = yt(t.instance.popper), v = parseFloat(g["margin" + u], 10),
                        _ = parseFloat(g["border" + u + "Width"], 10), b = m - t.offsets.popper[f] - v - _;
                ...
                fn: function (t, e) {
                    ...
                    var n = qt(t.instance.popper, t.instance.reference, e.padding, e.boundariesElement, t.positionFixed),
                        i = t.placement.split("-")[0], o = Gt(i), r = t.placement.split("-")[1] || "", s = [];
                    switch (e.behavior) {
                        case me:
                            s = [i, o];
                            break;
                    ...
                    return s.forEach((function (a, l) {
                        ...
                        var c = t.offsets.popper, u = t.offsets.reference, f = Math.floor,
                            ...
                            d = f(c.left) < f(n.left), p = f(c.right) > f(n.right), m = f(c.top) < f(n.top),
                ...
                order: 850, enabled: !0, fn: function (t, e) {
                    ...
                    var s = void 0 !== r ? r : e.gpuAcceleration, a = Ct(t.instance.popper), l = Ft(a),
                        ...
                        }(t, window.devicePixelRatio < 2 || !ue), f = "bottom" === n ? "top" : "bottom",
                        h = "right" === i ? "left" : "right", d = ne("transform"), p = void 0, m = void 0;
                    if (m = "bottom" === f ? "HTML" === a.nodeName ? -a.clientHeight + u.bottom : -l.height + u.bottom : u.top, p = "right" === h ? "HTML" === a.nodeName ? -a.clientWidth + u.right : -l.width + u.right : u.left, s && d) c[d] = "translate3d(" + p + "px, " + m + "px, 0)", c[f] = 0, c[h] = 0, c.willChange = "transform"; else {
                        var g = "bottom" === f ? -1 : 1, v = "right" === h ? -1 : 1;
    ...
    var we = "dropdown", Ee = new RegExp("ArrowUp|ArrowDown|Escape"), Te = {
        offset: 0,
        flip: !0,
        ...
        return n.toggle = function () {
            ...
            return "static" === this._config.display && (t.modifiers.applyStyle = {enabled: !1}), o(o({}, t), this._config.popperConfig)
    ...
    var Ae = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
        De = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean"}, Se = function () {
            function t(t, e) {
            ...
            return n.toggle = function (t) {
                ...
                var e = this, n = this._element.classList.contains("fade"), i = et.findOne(".modal-body", this._dialog);
    ...
    var Be = "tooltip", Re = new RegExp("(^|\\s)bs-tooltip\\S+", "g"), Fe = ["sanitize", "whiteList", "sanitizeFn"],
        We = {
            animation: "boolean",
            template: "string",
            ...
            whiteList: "object",
            popperConfig: "(null|object)"
        }, Ue = {AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left"}, Qe = {
            animation: !0,
            ...
            return n.enable = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    var e = V.trigger(this.element, this.constructor.Event.SHOW), n = function t(e) {
                ...
                if (null !== t) return "object" == typeof e && m(e) ? (e.jquery && (e = e[0]), void (this.config.html ? e.parentNode !== t && (t.innerHTML = "", t.appendChild(e)) : t.textContent = e.textContent)) : void (this.config.html ? (this.config.sanitize && (e = He(e, this.config.whiteList, this.config.sanitizeFn)), t.innerHTML = e) : t.textContent = e)
            }, n.getTitle = function () {
                ...
                var t = this.getTipElement(), e = t.getAttribute("class").match(Re);
    ...
    var Ke = "popover", Xe = new RegExp("(^|\\s)bs-popover\\S+", "g"), Ge = o(o({}, qe.Default), {}, {
        placement: "right",
        trigger: "click",
        content: "",
        template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
    }), $e = o(o({}, qe.DefaultType), {}, {content: "(string|element|function)"}), Ze = {
        ...
        return r.isWithContent = function () {
            ...
            var t = this.getTipElement(), e = t.getAttribute("class").match(Xe);
            null !== e && e.length > 0 && e.map((function (t) {
                return t.trim()
            })).forEach((function (e) {
                return t.classList.remove(e)
    ...
    var nn = "scrollspy", on = {offset: 10, method: "auto", target: ""},
        rn = {offset: "number", method: "string", target: "(string|element)"}, sn = function () {
            function t(t, e) {
                var n = this;
    ...
    var cn = function () {
        ...
        return n.show = function () {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains("active") || this._element.classList.contains("disabled"))) {
                var e, n = h(this._element), i = this._element.closest(".nav, .list-group");
                if (i) {
    ...
    var hn = {animation: "boolean", autohide: "boolean", delay: "number"},
        dn = {animation: !0, autohide: !0, delay: 500}, pn = function () {
            function t(t, e) {
            ...
            return n.show = function () {
                ...
                return t = o(o(o({}, dn), tt.getDataAttributes(this._element)), "object" == typeof t && t ? t : {}), v("toast", t, this.constructor.DefaultType), t
            }, n._setListeners = function () {
                var t = this;
